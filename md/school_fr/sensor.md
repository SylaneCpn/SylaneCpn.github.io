Communication de différents capteurs contrôlés par des cartes STM32, reliées en liaison CAN (Controller Area Network) à une IHM permettant à un opérateur de visualiser leurs valeurs.
